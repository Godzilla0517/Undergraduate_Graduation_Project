...
from model_builder import CustomLSTM
...
EPOCHS = 20
LEARNING_RATE = 0.001
model_4 = CustomLSTM(INPUT_SIZE, HIDDEN_SIZE, NUM_LAYERS, NUM_CLASSES, DEVICE).to(DEVICE)
...
save_model(model=model_4, 
           ...
           model_name="Model_4_CustomLSTM.pth")
