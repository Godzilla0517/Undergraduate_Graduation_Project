...
torch.save(
    obj=model_3.state_dict(), 
    f=r"C:\MachineLearning\Graduation_Project\models\model_3_GRU.pth"
)
loaded_model_3 = GRU(INPUT_SIZE, HIDDEN_SIZE, NUM_LAYERS, NUM_CLASSES, DEVICE)
loaded_model_3.load_state_dict(
    torch.load(f=r"C:\MachineLearning\Graduation_Project\models\model_3_GRU.pth"))
